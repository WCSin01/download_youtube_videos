...
from utils_ import utf8_decode, get_video_id, clean_filename, progress


def download_audio(url):
    try:
        yt = YouTube(url, "WEB",  use_oauth=True, allow_oauth_cache=True, on_progress_callback=progress)
